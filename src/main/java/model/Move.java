...
public class Move {
     ...
     * формации юнитов относительно точки ({@code x}, {@code y}). При значениях коэффициента больше {@code 1.0}
     * происходит расширение формации, при значениях меньше {@code 1.0} --- сжатие.
     * <p>
